...
const restaurant = {
  ...
  orderPizza: function (mainIngredient, ...otherIngredients) {
    ...
    console.log(
      `while cooking you need ${mainIngredient} with other ingredients such as ${otherIngredients}`
    );
  },
};
...
objects
const tempObj = { ...restaurant, name: 'abdullah', surname: 'ayoola' };
console.log(tempObj);
